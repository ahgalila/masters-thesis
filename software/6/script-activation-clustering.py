...
from utils import argmax, renderImage, renderDigit, getOperator, getOperatorSign, renderActivations
from PIL import Image, ImageDraw, ImageFont

def renderResults(name, results, test_x, activations_0, activations_1):
    
    image = Image.new('RGB', (28 * 6 + 512, len(results) * 180))
    draw = ImageDraw.Draw(image)

    for index, result in enumerate(results):

        renderDigit(draw, test_x[index][0], 0 * 28, index * 180 + 0 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[0][:10])) + ".png", 1 * 28, index * 180 + 0 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[0][10:20])) + ".png", 2 * 28, index * 180 + 0 * 36)
        renderImage(image, "MNIST_data/" + getOperator(result[0][20:24]) + ".png", 3 * 28, index * 180 + 0 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[0][-20:-10])) + ".png", 4 * 28, index * 180 + 0 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[0][-10:])) + ".png", 5 * 28, index * 180 + 0 * 36)
        renderActivations(draw, activations_0[index][0], 6 * 28, index * 180 + 0 * 36)
        renderActivations(draw, activations_1[index][0], 6 * 28, index * 180 + 0 * 36 + 16)

        renderDigit(draw, test_x[index][1], 0 * 28, index * 180 + 1 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[1][:10])) + ".png", 1 * 28, index * 180 + 1 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[1][10:20])) + ".png", 2 * 28, index * 180 + 1 * 36)
        renderImage(image, "MNIST_data/" + getOperator(result[1][20:24]) + ".png", 3 * 28, index * 180 + 1 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[1][-20:-10])) + ".png", 4 * 28, index * 180 + 1 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[1][-10:])) + ".png", 5 * 28, index * 180 + 1 * 36)
        renderActivations(draw, activations_0[index][1], 6 * 28, index * 180 + 1 * 36)
        renderActivations(draw, activations_1[index][1], 6 * 28, index * 180 + 1 * 36 + 16)

        renderDigit(draw, test_x[index][2], 0 * 28, index * 180 + 2 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[2][:10])) + ".png", 1 * 28, index * 180 + 2 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[2][10:20])) + ".png", 2 * 28, index * 180 + 2 * 36)
        renderImage(image, "MNIST_data/" + getOperator(result[2][20:24]) + ".png", 3 * 28, index * 180 + 2 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[2][-20:-10])) + ".png", 4 * 28, index * 180 + 2 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[2][-10:])) + ".png", 5 * 28, index * 180 + 2 * 36)
        renderActivations(draw, activations_0[index][2], 6 * 28, index * 180 + 2 * 36)
        renderActivations(draw, activations_1[index][2], 6 * 28, index * 180 + 2 * 36 + 16)
        ...
        renderImage(image, "MNIST_data/" + getOperator(result[3][20:24]) + ".png", 3 * 28, index * 180 + 3 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[3][-20:-10])) + ".png", 4 * 28, index * 180 + 3 * 36)
        renderImage(image, "MNIST_data/" + str(argmax(result[3][-10:])) + ".png", 5 * 28, index * 180 + 3 * 36)
        renderActivations(draw, activations_0[index][3], 6 * 28, index * 180 + 3 * 36)
        renderActivations(draw, activations_1[index][3], 6 * 28, index * 180 + 3 * 36 + 16)
...
renderResults("activation-results", results, test_x, activations_0, activations_1)
