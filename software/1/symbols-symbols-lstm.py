...
class LSTMModel(object):
    def __init__(self):
        ...
        self.n_inputs=10 # single mnist img (an mnist img is 28x28)
    ...
    def train(self, save_model=False):
        ...
        x_train = [x.reshape((-1, self.time_steps, self.n_inputs)) for x in self.trainDataSymbols]
    ...
    def evaluate(self, model=None):
        ...
        x_test = [x.reshape((-1, self.time_steps, self.n_inputs)) for x in self.testDataSymbols]
